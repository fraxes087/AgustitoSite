...
import { ResultEnum, BasicStatus, PermissionType, Permission } from '../types';

// Mock de permisos (definidos antes de usarlos)
...
const COMPONENTS_PERMISSION: Permission = {
  id: "2271615060673773",
  parentId: "",
...
const FUNCTIONS_PERMISSION: Permission = {
  id: "8132044808088488",
  parentId: "",
...
const MENU_LEVEL_PERMISSION: Permission = {
  id: "0194818428516575",
  parentId: "",
...
const OTHERS_PERMISSION: Permission[] = [
  {
    id: "3981225257359246",
    parentId: "",
...
// Roles (definidos después de los permisos)
const ADMIN_ROLE = {
  id: "4281707933534332",
  name: "Admin",
  label: "admin",
...
// Datos de usuarios (definidos después de los roles)
const users = [
  {
...
export const signin = (req: Request, res: Response): void => {
    ...
    // Asegurarnos de que permissions existe y no es undefined
    console.log("Backend - user permissions:", userInfo.permissions);
    ...
    res.json({
      ...
      data: {
        user: {
          ...userInfo,
          permissions: userInfo.permissions || [] // Asegurar que siempre hay un array
        },
        accessToken: 'mock-access-token-' + userInfo.id,
        refreshToken: 'mock-refresh-token-' + userInfo.id,
        expiresIn: 3600
      }
    });
  };
